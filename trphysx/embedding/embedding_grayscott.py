...
class GrayScottEmbedding(EmbeddingModel):
    ...
    def __init__(self, config):
        ...
        self.observableNet = nn.Sequential(
            ...
            # nn.BatchNorm3d(128),
            # 64 * 4 * 4 * 4
            # nn.Conv3d(512, 128, kernel_size=(1, 1, 1), stride=1, padding=0, padding_mode='circular'),
            # nn.LeakyReLU(0.02, inplace=True),
            # nn.BatchNorm3d(128),
            # 128 * 2 * 2 * 2
        ...
        self.recoveryNet = nn.Sequential(
            ...
            # nn.Conv3d(128, 512, kernel_size=(1, 1, 1), stride=1, padding=0, padding_mode='circular'),
            # nn.LeakyReLU(0.02, inplace=True),
            # nn.BatchNorm3d(256),
